...
#define MGN_PROFILE_BEGIN_SESSION(name, filepath) //::Voxymore::Core::Instrumentor::Get().BeginSession(name, filepath)
#define MGN_PROFILE_END_SESSION() //::Voxymore::Core::Instrumentor::Get().EndSession()
