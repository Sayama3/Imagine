...
// Thanks to https://stackoverflow.com/questions/1872220/is-it-possible-to-iterate-over-arguments-in-variadic-macros
//  for the foreach. Need to better understand how it works
...
#define MGN_ASSERT(...) MGN_EXPAND_MACRO( MGN_INTERNAL_ASSERT_IMPL(_, __VA_ARGS__) )
#define MGN_CORE_ASSERT(...) MGN_EXPAND_MACRO( MGN_INTERNAL_ASSERT_IMPL(_CORE_, __VA_ARGS__) )
