...
namespace Imagine
{
	...
	template<> inline std::string Math::to_string(const bool& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const float& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const double& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const long double& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const uint8_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const uint16_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const uint32_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const uint64_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const int8_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const int16_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const int32_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::to_string(const int64_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }

	template<> inline std::string Math::ToString(const bool& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const float& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const double& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const long double& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const uint8_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const uint16_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const uint32_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const uint64_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const int8_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const int16_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const int32_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
	template<> inline std::string Math::ToString(const int64_t& value) { /* MGN_PROFILE_FUNCTION(); */ return std::to_string(value); }
