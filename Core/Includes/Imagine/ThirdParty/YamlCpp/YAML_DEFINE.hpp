...
#define YAML_NODE_IN_VAL_STR(STR, VARIABLE, TYPE) v.##VARIABLE = node[STR].as<TYPE>();
#define YAML_NODE_IN_MGN_VAL_STR(STR, VARIABLE, TYPE) YAML_NODE_IN_VAL_STR(STR, VARIABLE, Imagine::Core::##TYPE);
...
#define YAML_NODE_IN_MGN_VAL(VARIABLE, TYPE) YAML_NODE_IN_MGN_VAL_STR(#VARIABLE, VARIABLE, TYPE)
