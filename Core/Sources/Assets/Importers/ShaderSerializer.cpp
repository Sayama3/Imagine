...
namespace Imagine::Core
{
	...
	{
		MGN_PROFILE_FUNCTION();
		MGN_CORE_ASSERT(IsGraphicShader(metadata.FilePath), "The asset '{0}' is not a shader", metadata.FilePath.string());
	...
	{
		MGN_PROFILE_FUNCTION();
		MGN_CORE_ASSERT(IsComputeShader(metadata.FilePath), "The asset '{0}' is not a compute shader", metadata.FilePath.string());
